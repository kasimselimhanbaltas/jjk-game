            ...
            {rivalCharacter.characterName === "sukuna" && (
                ...
                <div className="rival-interface">
                    ...
                    <div className="health-and-ce-bars">
                        ...
                        <div className="megumi-health" style={{ position: "absolute", width: "250px", height: "25px", top: "30%", }}>
                            <div style={{
                                position: "absolute", width: rivalCharacter.health.currentHealth * 250 / rivalCharacter.health.maxHealth, maxWidth: "250px", height: "25px",
                                top: "-120%", backgroundColor: "red", borderRadius: "10px", marginLeft: 250 - (rivalCharacter.health.currentHealth * 250 / rivalCharacter.health.maxHealth),
                            }}>
                            </div>
                            <p style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -280%)", fontSize: "15px" }}>{rivalCharacter.health.currentHealth}</p>
                        </div>
                        <div className="megumi-cursed-energy" style={{ position: "absolute", width: "250px", height: "25px", top: "30%" }}>
                            <div style={{
                                position: "absolute", width: rivalCharacter.cursedEnergy.currentCursedEnergy * 250 / rivalCharacter.cursedEnergy.maxCursedEnergy,
                                maxWidth: "250px", height: "25px", top: "-2%", backgroundColor: "purple", borderRadius: "10px",
                                marginLeft: 250 - (rivalCharacter.cursedEnergy.currentCursedEnergy * 250 / rivalCharacter.cursedEnergy.maxCursedEnergy)
                            }}>
                            </div>
                            <p style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -130%)", fontSize: "15px" }}>{rivalCharacter.cursedEnergy.currentCursedEnergy}</p>
                        </div>
                    </div>
                </div>
            )}
